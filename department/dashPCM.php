               ...
               <div class="small-box bg-aqua">
                  <div class="inner">
                     ...
                     $branches = array('kvgenggco_civil', 'kvgenggco_csis', 'kvgenggco_ec','kvgenggco_ee','kvgenggco_mech');
                       while($counter<5)
                       {
                        $tm    = "SELECT * FROM $branches[$counter].students where sem in('1C','1P','2C','2P')";
                  ...
                  <div class="icon">
                   ...
                   <a href="StudentPCM_list.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
               </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
