...
<div class="content-wrapper">
    ...
    <h1>
        Assigned Elective Subject Details
...
<div class="clearfix"></div> <br /> <br />
   <a href="selectElective.php" class="btn btn-primary pull-right">Assign Elective</a>
   <br/><br/>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                              <thead>
                                 ...
                                 <tbody>
                                     <?php
                                     $i=1;
        $sql = "SELECT students.Name,students.USN,students.sem,electiveStudent.eselectid, faculty.Name as 'Faculty Name',subjects.Name as subname,students.sec FROM `electiveStudent`,electiveDetails,students,faculty,subjects where faculty.idn=electiveDetails.eidn and electiveDetails.esubcode=subjects.subcode and electiveDetails.electId=electiveStudent.eselectid and electiveStudent.esusn=students.USN" ;
