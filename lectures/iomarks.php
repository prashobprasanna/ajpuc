...
function savemrk()
{
        ...
        data:{susn:susn,scode:scode,ssem:ssem,sint1:sint1,sint2:sint2,sint3:sint3,sint4:sint4,savgint:savgint,savgatt:savgatt,satt1:satt1,satt2:satt2,satt3:satt3,statt1:statt1,statt2:statt2,statt3:statt3,sasgmt:sasgmt,stotIA:stotIA,sumarks:sumarks,stmarks:stmarks},
                    ...
                    error: function(err) {
                 //   var abc= JSON.stringify(err)
                    alert("Please click Refresh button or (F5) to view data");
            ...
            <div class="panel panel-info">
              ...
              <form id="myForm" name="">
                   <p>
                     <table>
                       <?php
                  //  echo "<script type='text/javascript'>alert('$yestane');</script>";
                     
                                   $sq1z="SELECT `subjects`.`Name` AS 'Sub Name',`subjects`.`subcode` AS 'Sub Code',`subjects`.sem,`faculty`.`Name` AS 'Faculty Name' FROM `subjects`,`faculty`,electiveDetails WHERE faculty.idn=electiveDetails.eidn AND faculty.email="."'$facmail' and subjects.subcode="."'$subname' and electiveDetails.esubcode=subjects.subcode";
                                    $abc=0;
                                   ...
                                   //  echo "<script type='text/javascript'>alert('yestane= $yestane');</script>";
                                     ?>
                                        ...
                                        ?>    
                                          ...
                                          <!-- <label id="m" class="tatt1" style="font-style:italic;"></label>
                                                <label id="m1" class="tat222" style="font-style:italic;"></label>
                                                <label id="m1" class="tatt1" style="font-style:italic;"></label>
    ...
    location.href="?branch="+branch;
                ...
                -->          
                          ...
                          <?php 
                                ...
                                $csis = "kvgenggco_mech";
                                 ...
                                 $csis = "kvgenggco_civil";
                                  ...
                                  {*/
                                  //    $sq1q="SELECT students.Name as 'Student Name', students.`USN`,`subjects`.`Name` AS 'Sub Name',`subjects`.`subcode` AS 'Sub Code',`subjects`.sem,`faculty`.`Name` AS 'Faculty Name',subfac.sec FROM students,`subjects`,`faculty`,subfac,electiveDetails,electiveStudent WHERE subjects.sem=students.sem AND subjects.sem=subfac.sem and faculty.idn=subfac.idn and subfac.subcode='$subcode' and subfac.subcode=subjects.subcode and students.sec=subfac.sec and electiveDetails.esubcode=subjects.subcode and electiveDetails.electid=electiveStudent.eselectid and faculty.email='$facmail'";
                                       $sq1q="SELECT students.Name as 'Student Name', students.`USN`,`subjects`.`Name` AS 'Sub Name',`subjects`.`subcode` AS 'Sub Code',subjects.sem FROM students,`subjects`,`faculty`,electiveDetails,electiveStudent WHERE subjects.sem=students.sem and faculty.email='$facmail' and students.usn=electiveStudent.esusn and faculty.idn=electiveDetails.eidn and electiveDetails.esubcode=subjects.subcode and electiveDetails.electId=electiveStudent.eselectid and electiveDetails.esubcode='$subs' ORDER BY students.USN";
                                 /* }*/
                          ...
                          /*   if($dbz=="admin")
                             ...
                             $qz="SELECT `int1`,`att1`,`int2`,`att2`,`int3`,`att3`,`tatt1`,`tatt2`,`tatt3`,`aint4`,`avgint`,`avgatt`,`umarks`,`tmarks` FROM $csis.marks where `usn`='$newusn' AND `subcode`='$newsubc' AND `sem`='$newsem'";
