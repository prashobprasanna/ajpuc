		...
		/*	$sql1 ="SELECT students.Name,students.USN,students.cordinator,sem From students,faculty WHERE faculty.Name='$facname' and cordinator='$facname' and  students.sem<9 and students.sem>0";
               ...
               */
               ...
               // $usn= "4KV16CS004";
                   ...
                   $sqlsub= "SELECT distinct(marks.subcode) From $dbname1.marks,$dbname1.subjects,$dbname1.students where $dbname1.subjects.subcode=$dbname1.marks.subcode and $dbname1.marks.sem='$sem' and $dbname1.subjects.elective=0 and $dbname1.students.usn='$usn' and $dbname1.students.usn=$dbname1.marks.usn";
                    ...
                    <?php //$sub=0;
                     // $subcodaa= jfkjd;
                        ?>
                            ...
                            while($maklu<$s3)
                            {
                                $sql2= "SELECT marks.int1, marks.int2, marks.int3 From $branch.marks,$branch.students where  $branch.marks.usn=$branch.students.usn and $branch.marks.usn='$usn'  and $branch.students.sem='$sem' and $branch.marks.subcode='$arry[$maklu]' ORDER BY $branch.students.usn ASC";
                                $result2 = $con->query($sql2);
                                $m=mysqli_num_rows($result2);
                        //          echo "<script>alert('marks $m');</script>";
